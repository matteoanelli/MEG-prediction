...
IFS=';' read data figures models sub hand bs bsv bst epochs lr bias duration overlap patience y exp snl skern tnl tkern maxp ffnl ffhc drop act desc <<< $iteration
