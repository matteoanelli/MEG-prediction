...
if __name__ == "__main__":
    ...
    description = "within_final_MNET_Adam_dp04_l2_loss_wd_gaussianNoise04"
    ...
    df = df[['data_dir', 'figure_dir', 'model_dir', 'sub', 'hand',
             ...
             'learning_rate','weight_decay', 'patience', 'y_measure',
             'experiment', "desc"]]

    print(df)
    # np.savetxt("parameters.csv", df, delimiter=";")
    df.to_csv("within_parameters.csv", index=False, sep=";")
