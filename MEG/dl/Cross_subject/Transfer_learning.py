...
from MEG.dl.train import (
    train,
    train_bp,
    train_bp_MLP,
    train_bp_transfer,
    train_bp_fine_tuning,
    train_mlp_transfer,
)
...
def main(args):
    ...
    print(
        "Test dataset len {}, transfer dataset len {}".format(
            len(test_dataset), len(transfer_dataset)
        )
    )
    ...
    net, train_loss = train_bp_fine_tuning(
        net,
        transferloader,
        optimizer_trans,
        loss_function_trans,
    ...
    print(
        "root mean squared error after transfer learning {}".format(rmse_trans)
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--run",
        type=str,
        default="caadbf48e3c64647810e4945082d5f01",
        metavar="N",
