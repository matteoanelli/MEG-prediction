...
if __name__ == '__main__':
    ...
    if args.hand == 0: 
        ...
        acc_channels = {1: ["MISC001", "MISC002"],
                    2: ["MISC001", "MISC002"],
                    3: ["MISC001", "MISC002"],
                    4: ["MISC002"],
                    5: ["MISC001", "MISC002"],
        ...
        acc_channels = {1: ["MISC004", "MISC005"],
                        2: ["MISC004", "MISC005"],
                        3: ["MISC005"],
                        4: ["MISC004", "MISC005"],
                        5: ["MISC004"],
    ...
    print("Processing subject {}, hand {}".format(subj_n, hand))
    ...
    for i, fname in enumerate(raw_fnames):
        if os.path.isfile(raw_fnames[i]):
            ...
            epochs.append(mne.Epochs(raw, events, tmin=0., tmax=20., decim=4, baseline=(0, 0)))
            del raw
        else:
    ...
    import_opt = dict(fs=250,
                      ...
                      out_name='sub_'+str(subj_n)+'_' + hand,
                      input_type='trials',
                      overwrite=True,
                      n_folds=5,
                      target_type='float',
