...
srun python MEG/SPoC/Cross_subject/Cross_SPoC_MEG.py --data_dir $data --figure_dir $figures --model_dir $models --sub $sub --hand $hand --duration $duration --overlap $overlap --y_measure $y --experiment $exp
